...
public class QRCodeJDialog extends javax.swing.JDialog {
    ...
    public QRCodeJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setTitle("Lấy mã QR");
        this.setIconImage(ImagesHelper.getImage("/parking/icon/parking (1).png"));
        this.setLocationRelativeTo(null);
        this.jLableQRCode.setIcon(new ImageIcon(GiaoDichJDialog.qrCodeImage));
    ...
    private void initComponents() {
        ...
        jLableQRCode.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(55, 55, 55)
                        .addComponent(jLableQRCode, javax.swing.GroupLayout.PREFERRED_SIZE, 291, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(162, 162, 162)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(15, 15, 15)
                .addComponent(jLableQRCode, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(btnThoat)
